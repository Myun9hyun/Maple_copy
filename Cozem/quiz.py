...
# pdf_path = "Cozem/rule/아기자기_길드_규정_2023.pdf"
    ...
    with tab3:
        ...
        if quiz11_password == password11:
            ...
            st.write()
            '''
            마지막 스페셜 문제를 풀고 닉네임을 꼭 작성해줘!<br>
            실물 상품을 배송해주는 만큼, 닉네임을 적는 인원들은 주소 제공에 동의하는 것으로 간주할게!<br>
            닉네임을 적어준 인원들 중 3명을 추첨을 통해 뽑을거야<br>
            당첨된 인원들이 알려주는 주소는 배송목적으로만 사용할 뿐, 절대 유출되지도 않고 개인 목적으로 사용하지 않아<br>
            배송 후에는 바로 제공받은 주소는 파기할 예정이야<br>
            참여해줘서 정말 고마워!<br>
            '''
            FILE_PATH = 'data.csv'
