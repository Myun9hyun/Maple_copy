...
x_ver = width - text_width + 100
y_ver = height - text_height + 100
x_made = width - text_width + 100
...
# pdf_path = "Cozem/rule/아기자기_길드_규정_2023.pdf"
    ...
    with tab3:
        ...
        if quiz11_password == password11:
            ...
            st.write("실물 상품을 배송해주는 만큼, 닉네임을 적는 인원들은 주소 제공에 동의하는 것으로 간주할게!")
            st.write("닉네임을 적어준 인원들 중 3명을 추첨을 통해 뽑을거야")
