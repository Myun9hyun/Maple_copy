...
if choice == "메인페이지":
    ...
    * 연합길드 '초초' 보유
    ...
    with tab1:
        ...
        | :---: | :---: | :---: | :---: | :---:|
        | 길마👑 | 아기자기 | 나이트로드 | [![Colab](https://img.shields.io/badge/kakaotalk-뱌닢-yellow)](https://open.kakao.com/o/spPPOAhc) |[![maple](https://img.shields.io/badge/maplestory%20-%2314354C.svg?style=for-the-badge&logo=maplestory&logoColor=white)](https://maple.gg/u/아기자기) |
...
# pdf_path = "Cozem/rule/아기자기_길드_규정_2023.pdf"
    ...
    with tab3:
        ...
        st.markdown("[![maple](https://img.shields.io/badge/maplestory%20-%2314354C.svg?style=for-the-badge&logo=maplestory&logoColor=white)](https://maple.gg/u/영래곰)")
    ...
    with tab2:
        ...
        elif quiz8_password != ""  and quiz8_password != password8:
            st.error("비밀번호가 틀렸어!")
        ...
        if quiz10_password == password10:
            ...
            if st.button("정답 확인", key = "check_answer_button10"):
                if quiz10 == answer10:
                    ...
                    st.write("[뱐뎅]님의 기여도는 무려 380만이 넘어!┗|｀O′|┛")
                    st.write("기여도는 매일 5천까지만 채울 수 있으니 적어도 760일 넘게 기여도를 채워주셨어!")
